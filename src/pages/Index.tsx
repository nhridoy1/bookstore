      ...
      {featuredBooks.length > 0 && (
        <section className="container mx-auto px-4 py-20">
          <div className="flex items-end justify-between flex-wrap gap-4 mb-10">
            <div>
              <p className="text-sm uppercase tracking-[0.2em] text-primary font-medium mb-2">Hand-picked</p>
              <h2 className="font-heading text-4xl md:text-5xl font-bold">Featured Books</h2>
            </div>
